...
export default function PrivateRoute() {
    ...
    if(location.pathname.includes('/admin') && user && user[0]['identifiant'].toLowerCase() != 'admin') return <Navigate to='/unauthorized' />
    ...
    // Seul un auditeur peut acceder a la page de transcription des donnees
